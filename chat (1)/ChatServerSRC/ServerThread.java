...
public class ServerThread extends Thread {
    ...
    private static boolean logProtocol_YES = false;
    ...
    public LocalTime timeStamp() {
        ...
        return LocalTime.of(nowTime.getHour(), nowTime.getMinute());
    }
            ...
            while (true) {
                ...
                switch (command) {
                    ...
                    case REQ_EMOT: {
                        ...
                        try {
                            st_buffer.setLength(0);
                            st_buffer.append(YES_EMOT);
                            st_buffer.append(SEPARATOR);
                            st_buffer.append(id);
                            st_buffer.append(SEPARATOR);
                            st_buffer.append(imagepath);
                            st_buffer.append(SEPARATOR);
                            st_buffer.append(roomNumber);
                            st_buffer.append(SEPARATOR);
                            st_buffer.append(timeStamp());
